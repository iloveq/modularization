package com.credithc.hhr.module_home.view.widget;
...
public class RatioImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.home_RatioImageView);
        this.imageRatioType = typedArray.getInteger(R.styleable.home_RatioImageView_home_imageRatioType,
                RATIO_WIDTH_HEIGHT);
        this.imageRatio = typedArray.getFloat(R.styleable.home_RatioImageView_home_imageRatio, DEFAULT_RATIO);
        typedArray.recycle();
    }
